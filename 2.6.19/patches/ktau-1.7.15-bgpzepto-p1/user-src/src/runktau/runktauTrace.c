 ...
 * Version      : $Id: runktauTrace.c,v 1.1.2.1 2007/02/27 23:50:36 anataraj Exp $
 *
 ************************************************************/
...
void usage(char* cmd) {
	...
	fprintf(stderr, "EXAMPLE 4:\n To TRACE /usr/bin/find AND REST of system AND Enlarge Trace buffer size of the 'find' process to 409600 entries.\n");
